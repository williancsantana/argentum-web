...
public class RecebimentoLote {
    ...
    private List<OportunidadeAgravoPQAVS> lista = new ArrayList<OportunidadeAgravoPQAVS>();
    ...
    public RecebimentoLote(String nmAgravo, List<OportunidadeAgravoPQAVS> lista) {
        this.nmAgravo = nmAgravo;
        this.lista = lista;
    }

    public List<OportunidadeAgravoPQAVS> getLista() {
        return lista;
    }

    public void setLista(List<OportunidadeAgravoPQAVS> lista) {
        this.lista = lista;
    }
