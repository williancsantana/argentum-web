 ...
 * @author geraldo
 */
public class RecebimentoLote extends Agravo {
...
//        //CONSTRUIR AQUI O ALGORITMO
//        //criar aqui o algoritmo
...
//        //CALCULA A TAXA PARA TODOS OS MUNICIPIOS
//        List<OportunidadeAgravoPQAVS> beans = new ArrayList();
// //      List<RecebimentoLoteAgravo> beans = new ArrayList();
//        Collection<OportunidadeAgravoPQAVS> municipioBean = municipiosBeans.values();
//
//        for (Iterator<OportunidadeAgravoPQAVS> it = municipioBean.iterator(); it.hasNext();) {
//            OportunidadeAgravoPQAVS agravoDBF = it.next();
...
//       
//        parametros.put("parDtInicioTransf", this.dtInicioTransf);
//        parametros.put("parDtFimTransf", this.dtFimTransf);
//        parametros.put("parDtInicioReceb", this.dtInicioReceb);
//        parametros.put("parDtFimReceb", this.dtFimReceb);
//        
//        /*
...
//    @Override
//    public String getDtInicioTransf() {
//        return super.getDtInicioTransf();
//    }
//
//    @Override
//    public void setDtFimTransf(String dtFimTransf) {
//        super.setDtFimTransf(dtFimTransf);
//    }
//
//    @Override
//    public String getDtInicioReceb() {
//        return super.getDtInicioReceb();
//    }
//
//    @Override
//    public void setDtFimReceb(String dtFimReceb) {
//        super.setDtFimReceb(dtFimReceb);
//    }
//    
//    
