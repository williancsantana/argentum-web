 ...
 * @author geraldo
 */
public class SifilisCongenitaIncidenciaPactuacaoBack extends Agravo {

    static String ANO;

    public SifilisCongenitaIncidenciaPactuacaoBack(boolean isDbf) {
        this.setDBF(isDbf);
    ...
    public SifilisCongenitaIncidenciaPactuacaoBack() {
    }
