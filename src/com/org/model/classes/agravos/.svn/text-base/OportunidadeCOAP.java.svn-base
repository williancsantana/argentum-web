 ...
 * @author geraldo 
 */
public class OportunidadeCOAP extends Agravo {
    ...
    private List<CasoOportunidadeCOAP> listExportacao = new ArrayList<CasoOportunidadeCOAP>();

    public List<CasoOportunidadeCOAP> getListExportacao() {
        return listExportacao;
    }

    public void setListExportacao(List<CasoOportunidadeCOAP> listExportacao) {
        this.listExportacao = listExportacao;
    }

    public OportunidadeCOAP(boolean isDbf) {
        this.setDBF(isDbf);
...
//    private void iniciaAgravosValidos() {
//        /*
//        getAgravosValidos().add("B19"); //Hepatite Viral
//        getAgravosValidos().add("B551"); //LTA
//        getAgravosValidos().add("P350"); //SRC
//        *///desativados devido à nova lógica do relatório para atender demanda COAP
//       
////        getAgravosValidos().add("Y59"); ///EVENTOS ADVERSOS POS-VACINACAO
// //       getAgravosValidos().add("X29"); ///ACIDENTE POR ANIMAIS PECONHENTOS
//        
// //       getAgravosValidos().add("A35"); ///TÉTANO ACIDENTAL
//        getAgravosValidos().add("B09"); 
//        getAgravosValidos().add("B091");
//        getAgravosValidos().add("B092");
////        getAgravosValidos().add("B571"); ///DOENÇA DE CHAGAS
//        getAgravosValidos().add("A009");
//        getAgravosValidos().add("A379");
//        getAgravosValidos().add("A369");
//        getAgravosValidos().add("A959");
////        getAgravosValidos().add("A010"); ///FEBRE TIFÓIDE
//        getAgravosValidos().add("A279");
//        getAgravosValidos().add("A809");
////        getAgravosValidos().add("A209");///PESTE
//        getAgravosValidos().add("A829");
////        getAgravosValidos().add("A33");///TETANO NEONATAL
////        getAgravosValidos().add("B550");///LEISHMANIOSE VICERAL
//        getAgravosValidos().add("A988");
//        getAgravosValidos().add("A779");
//        getAgravosValidos().add("G039");
//        getAgravosValidos().add("A90");
//        getAgravosValidos().add("A051");
////        getAgravosValidos().add("A923");///FEBRE DO NILO
////        getAgravosValidos().add("B54");///MALÁRIA
//    }
    ...
    private HashMap<String, OportunidadeAgravoCOAP> populaMunicipiosBeansOportuno(String uf, String idMunicipio, String codRegional) {
        DBFUtil utilDbf = new DBFUtil();
        HashMap<String, String> municipios = new HashMap<String, String>();
        HashMap<String, OportunidadeAgravoCOAP> municipiosBeans = new HashMap<String, OportunidadeAgravoCOAP>();
                    ...
                    if (codRegional.length() > 0 && codRegional.equals(utilDbf.getString(rowObjects1, "ID_REGIAO"))) {
                        if (!utilDbf.getString(rowObjects1, "NM_MUNICIP").startsWith("IGNORADO") && utilDbf.getString(rowObjects1, "NM_MUNICIP").lastIndexOf("TRANSF.") == -1 && utilDbf.getString(rowObjects1, "NM_MUNICIP").lastIndexOf("ATUAL BENTO GONCALVES") == -1) {
                            if ((utilDbf.getString(rowObjects1, "SG_UF").equals("DF") && utilDbf.getString(rowObjects1, "NM_MUNICIP").equals("BRASILIA")) || !utilDbf.getString(rowObjects1, "SG_UF").equals("DF")) {
                                OportunidadeAgravoCOAP agravoDbf = new OportunidadeAgravoCOAP();
                      ...
                      //          agravoDbf.setNmAgravo(utilDbf.getString(rowObjects1, "SG_UF")); //ALTEREI PARA MUNICIPIO 21mar2013
                                ...
                                try {
                                    ...
                                    Logger.getLogger(OportunidadeCOAP.class.getName()).log(Level.SEVERE, null, ex);
                                }
...
//VERIFICAR ESSE TRECHO DE CÓDIGO
        ...
        HashMap<String, OportunidadeAgravoCOAP> municipiosBeansRetorno = new HashMap<String, OportunidadeAgravoCOAP>();
    ...
    public String buscaNomeAgravo(String codAgravo) {
        ...
        if (codAgravo.equals("U049")) { retorno = "SINDROME RESPIRAT. AGUDA GRAVE ASSOC. A CORONAVIRUS";}
...
//    }
    ...
    public HashMap<String, OportunidadeAgravoCOAP> populaAgravosBeans(String agravoSelecionado) {
        DBFUtil utilDbf = new DBFUtil();
        HashMap<String, String> hashAgravos = new HashMap<String, String>();
        HashMap<String, OportunidadeAgravoCOAP> agravosBeans = new HashMap<String, OportunidadeAgravoCOAP>();
        //se codRegional estiver preenchida, deve buscar somente os municipios pertencentes a ela
        ...
        HashMap<String, OportunidadeAgravoCOAP> agravosBeansRetorno = new HashMap<String, OportunidadeAgravoCOAP>();
    ...
    private void populaBeanExportacaoDBF(String situacao, String agravo, String idMunicipioNotificacao,
        ...
        CasoOportunidadeCOAP caso = new CasoOportunidadeCOAP();
     ...
     */
    private String classificaNotificacao(int diferencaDatas, int diferencaValida, OportunidadeAgravoCOAP agravoBean, int classificaoFinal) {
        String retorno = "";
        if (diferencaDatas < 0) {
    ...
    private List calculaEstadoMunicipio(DBFReader reader, Map parametros) throws ParseException, DBFException {
        ...
        CasoOportunidadeCOAP casoListado = null;
        ...
        if (todosMunicipio && parametros.get("parCodRegional").toString().length() > 0) {
            municipiosRegionais = verificaMunicipioRegiaoSaude(parametros.get("parCodRegional").toString());
            porRegional = true;
        }
//        if (parametros.get("parNomeMunicipio").equals("TODOS")) {
...
//        }
        ...
        String agravo;
        OportunidadeAgravoCOAP municipioResidencia;
...
//                            }
                            if (municipioResidencia != null && verificaAgravoOportuno(agravo) && continuaCalculo) {
                                ...
                                if (agravodbf.isBetweenDates(dtNotificacao, dataInicio, dataFim)) {
                                    casoListado = new CasoOportunidadeCOAP();
                                    String situacao = "";
                                    ...
                                    if (dtEncerramento == null) {
                                        ...
                                        if (this.isTemListagem()) {
                                            ...
                                            this.getListagemCasosCOAP().add(casoListado);
    ...
    //                                    dtEncerramentoExportacao);
        ...
        List<OportunidadeAgravoCOAP> beans = new ArrayList();
        Collection<OportunidadeAgravoCOAP> municipioBean = municipiosBeans.values();

        for (Iterator<OportunidadeAgravoCOAP> it = municipioBean.iterator(); it.hasNext();) {
            OportunidadeAgravoCOAP agravoDBF = it.next();
...
//            }
        ...
        //calcular o total
        OportunidadeAgravoCOAP agravoBean = new OportunidadeAgravoCOAP();
        ...
        if (!isPorAgravo() && !todosMunicipio) {
            beans = new ArrayList<OportunidadeAgravoCOAP>();
    ...
    public HashMap<String, OportunidadeAgravoCOAP> populaUfsBeansOportuno() {
        DBFUtil utilDbf = new DBFUtil();
        HashMap<String, String> uf = new HashMap<String, String>();
        HashMap<String, OportunidadeAgravoCOAP> ufsBeans = new HashMap<String, OportunidadeAgravoCOAP>();
        //se codRegional estiver preenchida, deve buscar somente os municipios pertencentes a ela
        ...
        HashMap<String, OportunidadeAgravoCOAP> ufsBeansRetorno = new HashMap<String, OportunidadeAgravoCOAP>();
...
//                            }
    ...
    private List getCalculaResultadoPorMunicipio(Connection con, Map parametros) throws SQLException {
        ...
        ResultSet rs, rs2;
        OportunidadeAgravoCOAP agravoBean = null;
        List<OportunidadeAgravoCOAP> beans = new ArrayList();
        CasoOportunidadeCOAP casoListado = null;
        ...
        while (rs.next()) {
            ...
            agravoBean = new OportunidadeAgravoCOAP();
...
//        hashColunas.put("ORIGEM", new ColunasDbf(30));
    ...
    public DBFWriter getLinhas(HashMap<String, ColunasDbf> colunas, List bean, DBFWriter writer) throws DBFException, IOException {
        ...
        for (int i = 0; i < bean.size(); i++) {
            ...
            OportunidadeAgravoCOAP agravo = (OportunidadeAgravoCOAP) bean.get(i);
            if (isPorAgravo()) {
...
//            rowData[10] = "OPORTUNIDADE-SINANNET";
    ...
    public String getCaminhoJasper() {
        return "/com/org/relatorios/oportunidadeCOAP.jasper";
    }
