 ...
 * @author geraldo
 */
public class HepatiteBC extends Agravo {
    ...
    public void init(String tipoBanco) {
        ...
        if (!isDBF()) {
            this.setSqlNumeradorMunicipioEspecifico("select count(*) as numerador from dbsinan.tb_notificacao as t1, dbsinan.tb_investiga_hepatite as t2 "
                    + "where t1.co_cid = 'B19' and (t1.dt_notificacao BETWEEN ?  " + "AND ?) and "
                    + "t1.co_uf_residencia= ? and "
                    + "t1.co_municipio_residencia = ? and "
                    + "t1.nu_notificacao=t2.nu_notificacao and "
                    + "t1.dt_notificacao=t2.dt_notificacao and "
                    + "t1.co_municipio_notificacao=t2.co_municipio_notificacao and "
                    + "((t1.tp_classificacao_final=1 and t2.tp_classificacao_etiologica = '02' and tp_soro_hbsag = 1) or "
                    + "(t1.tp_classificacao_final=1 and t2.tp_classificacao_etiologica = '03' and tp_soro_hcv = 1) or "
                    + "(t1.tp_classificacao_final=1 and t2.tp_classificacao_etiologica = '06' and tp_soro_hcv = 1 and tp_soro_hbsag = 1))");
            this.setSqlDenominadorMunicipioEspecifico("select count(*) as denominador from dbsinan.tb_notificacao as t1, dbsinan.tb_investiga_hepatite as t2 "
                    + "where t1.co_cid = 'B19' and (t1.dt_notificacao BETWEEN ?  " + "AND ?) and "
                    + "t1.co_uf_residencia= ? and "
                    + "t1.co_municipio_residencia = ? and "
                    + "t1.nu_notificacao=t2.nu_notificacao and "
                    + "t1.dt_notificacao=t2.dt_notificacao and "
                    + "t1.co_municipio_notificacao=t2.co_municipio_notificacao and "
                    + "t1.tp_classificacao_final=1 and t2.tp_classificacao_etiologica in ('02','03','06')");

            this.setSqlNumeradorEstado("select count(*) as numerador from dbsinan.tb_notificacao as t1, dbsinan.tb_investiga_hepatite as t2 "
                    + "where t1.co_cid = 'B19' and (t1.dt_notificacao BETWEEN ?  " + "AND ?) and "
                    + "t1.co_uf_residencia= ? and "
                    + "t1.nu_notificacao=t2.nu_notificacao and "
                    + "t1.dt_notificacao=t2.dt_notificacao and "
                    ...
                    + "(t1.tp_classificacao_final=1 and t2.tp_classificacao_etiologica = '03' and tp_soro_hcv = 1) or "
                    + "(t1.tp_classificacao_final=1 and t2.tp_classificacao_etiologica = '06' and tp_soro_hcv = 1 and tp_soro_hbsag = 1))");
            this.setSqlDenominandorEstado("select count(*) as denominador from dbsinan.tb_notificacao as t1, dbsinan.tb_investiga_hepatite as t2 "
                    + "where t1.co_cid = 'B19' and (t1.dt_notificacao BETWEEN ?  " + "AND ?) and "
                    + "t1.co_uf_residencia= ? and "
                    + "t1.nu_notificacao=t2.nu_notificacao and "
                    + "t1.dt_notificacao=t2.dt_notificacao and "
                    + "t1.co_municipio_notificacao=t2.co_municipio_notificacao and "
                    + "t1.tp_classificacao_final=1 and t2.tp_classificacao_etiologica in ('02','03','06')");
            this.setSqlNumeradorCompletitude("select count(*) as numerador from dbsinan.tb_notificacao as t1, dbsinan.tb_investiga_hepatite as t2 "
                    + "where t1.co_cid = 'B19' and (t1.dt_notificacao BETWEEN ?  " + "AND ?) and "
                    + "t1.co_uf_residencia= ? and "
                    + "t1.nu_notificacao=t2.nu_notificacao and "
                    + "t1.dt_notificacao=t2.dt_notificacao and "
                    + "t1.co_municipio_notificacao=t2.co_municipio_notificacao and "
                    + "t1.tp_classificacao_final=1 and t2.tp_classificacao_etiologica is null");
    ...
    private void calculaBrasil(DBFReader reader, Map parametros) throws ParseException {
        ...
        Object[] rowObjects;
        int soroHBSAG, soroHCV, classificacaoFinal, completitude = 0, denominadorCompletitude = 0;
        String total;
    ...
    public void calcula(DBFReader reader, Map parametros) {
        ...
        if (municipios.equals("sim") && !brasil.equals("brasil")) {
            ...
            if (brasil.equals("brasil")) {
                ...
                DBFUtil utilDbf = new DBFUtil();
                String classificacaoEtiologica;
                int soroHBSAG, soroHCV, classificacaoFinal, completitude = 0,
                        denominadorCompletitude = 0;
                String total;
                DecimalFormat df = new DecimalFormat("0.00");
                int denominadorEstadual = 0;
                int numeradorEstadual = 0;
