 ...
 * @author geraldo
 */
public class OportunidadeMalariaPactuacao extends javax.swing.JPanel {
     ...
     */
    public OportunidadeMalariaPactuacao() {
        initComponents();
...
//      session.setTemListagem(cbGerarListagem.isSelected());
        ...
        session.setRelatorio("OportunidadeMalariaPactuacao");
        session.execute();
