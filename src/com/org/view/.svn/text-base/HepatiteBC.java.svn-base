 ...
 * HepatiteBC.java
 *
 * Created on 01/06/2010, 16:22:41
 */
 ...
 * @author geraldo
 */
public class HepatiteBC extends javax.swing.JPanel {

    SessionFacadeImpl session = new SessionFacadeImpl();

    /** Creates new form HepatiteBC */
    public HepatiteBC() {
        initComponents();
    ...
    private boolean preencheuFormulario() {
        ...
        int dt_inicio=Integer.parseInt(SinanDateUtil.dateToStringException(dataInicio.getDate(), "dd/MM/yyyy").substring(6, 10));
        if (dt_inicio < 2007 || dt_inicio > 2009) {
            Master.mensagem("Relatório disponível apenas para ano de notificação entre 2007 e 2009.");
            return false;
        }
        int dt_fim=Integer.parseInt(SinanDateUtil.dateToStringException(dataFim.getDate(), "dd/MM/yyyy").substring(6, 10));
        if (dt_fim < 2007 || dt_fim > 2009) {
            Master.mensagem("Relatório disponível apenas para ano de notificação entre 2007 e 2009.");
            return false;
        }
        try {
    ...
    private void btCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCalcularActionPerformed
        ...
        session.setRelatorio("HepatiteBC");
        session.execute();
