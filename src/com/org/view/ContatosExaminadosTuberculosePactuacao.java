 ...
 * @author geraldo
 */
public class ContatosExaminadosTuberculosePactuacao extends javax.swing.JPanel {
     ...
     */
    public ContatosExaminadosTuberculosePactuacao() {
        initComponents();
...
//      session.setTemListagem(cbGerarListagem.isSelected());
        ...
        session.setRelatorio("ExaminadosTuberculosePactuacao");
        session.execute();
